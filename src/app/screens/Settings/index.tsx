...
export const Settings = (props: { componentId: string }) => {
  ...
  const renderPositioningOptions = () => {
    ...
    return (
      <View>
        <Text style={{ color: "gray", margin: 15 }}>Positioning Options</Text>
  ...
  const renderPositioningSensors = () => {
    const { outdoorLocationOptions } = locationOptions;
    return (
      <View>
        <Text style={{ color: "gray", margin: 15 }}>Positioning Sensos</Text>

        <View style={styles.switchContainer}>
          <Text>{"BLE Positioning:\t"}</Text>
          <Switch
            onValueChange={(toggle) => {
        ...
        {Platform.OS == "android" && (<View style={styles.switchContainer}>
          <Text>{"Use Foreground Service:\t"}</Text>
          <Switch
            onValueChange={(toggle) => {
              updateLocationOptions({ ...locationOptions, useForegroundService: toggle });
            }}
        ...
        <View style={styles.switchContainer}>
          <Text>{"Enable open sky detector:\t"}</Text>
          <Switch
            onValueChange={(toggle) => {
              updateLocationOptions({
                ...locationOptions,
        ...
        {Platform.OS == "android" && (
          <View style={styles.switchContainer}>
            <Text>{"Ignore WIFI throtlling:\t"}</Text>
            <Switch
              onValueChange={(toggle) => {
                updateLocationOptions({
                  ...locationOptions,
        ...
        <View style={styles.rowContainer}>
          <Text> {"Realtime Update Interval (Seconds): "} </Text>
          <Menu
            onSelect={(value) =>
              updateLocationOptions({
                ...locationOptions,
